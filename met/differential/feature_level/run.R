...
if (grepl("ricard",Sys.info()['nodename'])) {
  ...
  io$outdir <- "/hps/nobackup2/research/stegle/users/ricard/Guo_2017/met/differential/feature_level"
  io$tmpdir <- "/hps/nobackup2/research/stegle/users/ricard/Guo_2017/met/differential/feature_level/tmp"; dir.create(io$tmpdir, showWarnings=F)
} else {
