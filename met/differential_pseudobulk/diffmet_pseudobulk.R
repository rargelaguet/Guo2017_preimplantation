...
if (grepl("ricard",Sys.info()['nodename'])) {
  ...
  source("/Users/ricard/Guo2017_preimplantation/met/differential_pseudobulk/utils.R")
} else if(grepl("yoda",Sys.info()['nodename'])){
  source("/homes/ricard/Guo2017_preimplantation/settings.R")
  source("/homes/ricard/Guo2017_preimplantation/met/differential_pseudobulk/utils.R")
} else {
