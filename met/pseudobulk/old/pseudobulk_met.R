...
if (grepl("ricard",Sys.info()['nodename'])) {
  io$in.data <- "/Users/ricard/data/Guo_2017/met/cpg_level"
  io$in.metadata <- "/Users/ricard/data/Guo_2017/sample_metadata.txt"
  io$out.dir <- "/Users/ricard/data/Guo_2017/met/cpg_level/pseudobulk"
} else {
  io$in.data <- "/hps/nobackup/stegle/users/ricard/Guo_2017/met/cpg_level"
  io$in.metadata <- "/hps/nobackup/stegle/users/ricard/Guo_2017/sample_metadata.txt"
  io$out.dir <- "/hps/nobackup/stegle/users/ricard/Guo_2017/met/cpg_level/pseudobulk"
}
