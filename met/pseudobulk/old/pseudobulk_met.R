...
if (grepl("ricard",Sys.info()['nodename'])) {
  io$in.data <- "/Users/ricard/data/Guo2017_preimplantation/met/cpg_level"
  io$in.metadata <- "/Users/ricard/data/Guo2017_preimplantation/sample_metadata.txt"
  io$out.dir <- "/Users/ricard/data/Guo2017_preimplantation/met/cpg_level/pseudobulk"
} else {
  io$in.data <- "/hps/nobackup/stegle/users/ricard/Guo2017_preimplantation/met/cpg_level"
  io$in.metadata <- "/hps/nobackup/stegle/users/ricard/Guo2017_preimplantation/sample_metadata.txt"
  io$out.dir <- "/hps/nobackup/stegle/users/ricard/Guo2017_preimplantation/met/cpg_level/pseudobulk"
}
...
sample_metadata <- fread(io$in.metadata)[,c("stage","id_met")] %>% 
