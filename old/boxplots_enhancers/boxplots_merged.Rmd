...
# Guo2017
io$sample.metadata2 <- "/Users/ricard/data/Guo_2017/sample_metadata.txt"
io$met.dir2 <- "/Users/ricard/data/Guo_2017/met/feature_level"
io$acc.dir2 <- "/Users/ricard/data/Guo_2017/acc/feature_level"
```
...
# Ectoderm-specific
diff.met.ect <- fread("/Users/ricard/Guo_2017/mofa/out/Factor_Met_EctEnhancers_top100.txt") %>% 
  .[,sign:=value>0] %>% 
  setnames("feature","id") %>%
...
# Ectoderm-specific
diff.acc.ect <- fread("/Users/ricard/Guo_2017/mofa/out/Factor_Acc_EctEnhancers_top100.txt") %>% 
  .[,sign:=value>0] %>%
  setnames("feature","id") %>%
  .[,id:=substr(id,1,nchar(id)-3)]
