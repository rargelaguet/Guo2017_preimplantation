---
title: "Guo2017: quantification of DNA accessibility in mithocondrial DNA"
output: 
...
io$metadata <- "/Users/ricard/data/Guo_2017/sample_metadata.txt"
io$data <- "/Users/ricard/data/Guo_2017/acc/gpc_level"
io$outdir <- "/Users/ricard/Guo_2017/out"
...
```{r}
# stats <- fread("/Users/ricard/data/Guo_2017/acc/stats/stats.txt") %>%
#   .[,mean:=mean/100]
# 
# to.plot <- dt[,.(rate=mean(rate)), by="id_acc"] %>%
#   merge(metadata,by="id_acc") %>%
