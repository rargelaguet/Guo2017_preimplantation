...
# io$stats <- paste0(io$basedir,"/acc/stats/stats_per_chromosome.txt.gz")
...
##############################################
## Plot accessibility rate per embryo and chr ##
##############################################
...
##############################################
## Plot accessibility rate per cell and chr ##
##############################################
...
pdf(sprintf("%s/accessibility_per_chr.pdf",io$outdir), width=10, height=8)
# png(sprintf("%s/barplots_%s.png",io$outdir,i), width=6, height=4, units="in", res=400)
print(p)
dev.off()
